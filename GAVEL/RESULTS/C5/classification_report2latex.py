...
if __name__ == '__main__':
    with open('/Users/juridirocco/development/ghaction/results/all/Fold_1_Results_scores.csv') as f:
        data = parse_classification_report(f.read())
    with open('/Users/juridirocco/development/ghaction/results/all/Fold_1_Results_scores.tex', 'w') as writer: writer.write(report_to_latex_table(data))